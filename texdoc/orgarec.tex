...
JavaScript is extensively used for the actual browser-side visualisation. The D3.js library provides advanced visualization tools. 

\section{Implemented visualisations}
The final version of our project includes two different visualization principles. The first one, which was the goal of the project, represents a force directed graph of courses which are linked by their relations. The second type of representation, which was found to be really useful to explore SHS courses, helps representing the repartition of students in courses given their section. 

\subsection{Organic graph of courses}
\paragraph{Key principles}
\paragraph{Displaying more information on courses}

\subsection{SHS explorer}
