...
This remarks show that the testers had a lot of difficulties to understand easily how the visualizations worked and what they represented. It is thus necessary to implement an \emph{help} button. 
